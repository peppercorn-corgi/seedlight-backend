...
Write each version as a single paragraph, designed for mobile reading in spare moments. Write as if a caring pastor is having a quiet conversation, not an academic essay. Within each paragraph, wrap 1-2 sentences in **bold markers** (e.g., "**this sentence will be highlighted**"). The highlighted text must be sentences that directly comfort, warm, or empower the reader — the kind of words that make someone pause and feel seen. Do NOT highlight analytical comparisons or intellectual observations.
